...
export const transportComparisons = [
  ...
  { mode: "Xe cong nghe", dailyVnd: 35_000, timeDeltaMinutes: -5 },
...
export const mockTransactions: CommuteTransaction[] = [
  { amountVnd: 38_000, category: "routine", merchant: "CAFE A", source: "sms", occurredAt: day(2) },
  { amountVnd: 8_000, category: "parking", merchant: "GUI XE Q.1", source: "sms", occurredAt: day(2) },
  { amountVnd: 71_000, category: "ride_hailing", merchant: "XE CONG NGHE", source: "sms", occurredAt: evening(2) },
  { amountVnd: 50_000, category: "fuel", merchant: "TRAM XANG", source: "sms", occurredAt: day(3) },
  { amountVnd: 8_000, category: "parking", merchant: "GUI XE Q.1", source: "sms", occurredAt: day(3) },
  { amountVnd: 38_000, category: "routine", merchant: "CAFE A", source: "sms", occurredAt: day(4) },
  { amountVnd: 8_000, category: "parking", merchant: "GUI XE Q.1", source: "sms", occurredAt: day(4) },
  { amountVnd: 85_000, category: "ride_hailing", merchant: "XE CONG NGHE", source: "sms", occurredAt: evening(4) },
  { amountVnd: 38_000, category: "routine", merchant: "CAFE A", source: "sms", occurredAt: day(5) },
  ...
  { amountVnd: 38_000, category: "routine", merchant: "CAFE A", source: "sms", occurredAt: day(6) },
  { amountVnd: 50_000, category: "fuel", merchant: "TRAM XANG", source: "sms", occurredAt: day(7) },
  { amountVnd: 8_000, category: "parking", merchant: "GUI XE Q.1", source: "sms", occurredAt: day(8) },
  { amountVnd: 78_000, category: "ride_hailing", merchant: "XE CONG NGHE", source: "sms", occurredAt: evening(8) },
  { amountVnd: 38_000, category: "routine", merchant: "CAFE A", source: "sms", occurredAt: day(9) },
  { amountVnd: 8_000, category: "parking", merchant: "GUI XE Q.1", source: "sms", occurredAt: day(9) },
  { amountVnd: 35_000, category: "routine", merchant: "CAFE B", source: "sms", occurredAt: day(10) },
